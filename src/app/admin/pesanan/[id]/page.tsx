    ...
    return (
        <div className="mx-auto flex max-w-2xl flex-col gap-6">
            <div className="flex items-center justify-between">
                ...
                <Link
                    href={`/admin/pesanan/${order.id}/cetak`}
                    target="_blank"
                    className="rounded-md border border-black/10 px-3 py-1.5 text-sm transition hover:bg-black/5 dark:border-white/10 dark:hover:bg-white/10"
                >
                    🖨️ Cetak
                </Link>
            </div>
            ...
            <div className="flex flex-col gap-2 rounded-lg border border-black/10 p-4 text-sm dark:border-white/10">
                <h2 className="font-medium">Informasi Pesanan</h2>
                ...
                <div className="flex justify-between">
                    ...
                    <span>{order.createdAt.toLocaleString("id-ID")}</span>
                </div>
                <div className="flex justify-between">
            ...
            <div className="flex flex-col gap-2 rounded-lg border border-black/10 p-4 text-sm dark:border-white/10">
                ...
                <div className="flex justify-between">
                    <span className="text-black/60 dark:text-white/60">Nama</span>
                ...
                {order.user.phone && (
                    <div className="flex justify-between">
                        <span className="text-black/60 dark:text-white/60">Telepon</span>
            ...
            {order.payment && (
                <div className="flex flex-col gap-2 rounded-lg border border-black/10 p-4 text-sm dark:border-white/10">
                    ...
                    <div className="flex justify-between">
                        <span className="text-black/60 dark:text-white/60">Provider</span>
                    ...
                    {order.payment.transactionId && (
                        <div className="flex justify-between">
                            <span className="text-black/60 dark:text-white/60">Transaction ID</span>
